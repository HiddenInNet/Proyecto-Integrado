...
INSERT INTO `users` (username, password, email, name, last_name, birth_date, phone, profile_create_date, biography, profile_image)
    VALUES
        ('usuario1', 'password1', 'usuario1@example.com', 'Juan', 'Pérez', '1990-05-15','660536475', '2022-01-01', 'Biografía de Juan Pérez', NULL),
        ('usuario2', 'password2', 'usuario2@example.com', 'María', 'Gómez', '1985-08-25','626137535', '2022-01-02', 'Biografía de María Gómez', NULL),
        ('usuario3', 'password3', 'usuario3@example.com', 'Carlos', 'López', '1998-12-10','637536826', '2022-01-03', 'Biografía de Carlos López', NULL);
